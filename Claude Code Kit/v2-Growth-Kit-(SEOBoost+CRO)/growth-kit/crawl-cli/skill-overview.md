...
crawl-cli is a utility that supports research and competitive intelligence workflows.

**Related Skills:**

- `idea-to-product` - Use for competitive-intel phase to extract competitor websites
- `research` - Use for competitor-analysis to gather systematic intelligence
- `marketing` - Use for content inspiration and competitive positioning research

### Common Integration Workflows

**Competitive Intelligence (idea-to-product/competitive-intel.md):**

```bash
# Extract competitor's full marketing site for analysis
...
crawl-cli https://competitor.com/pricing -o "./research/competitor-pricing.md"
crawl-cli https://competitor.com/features -o "./research/competitor-features.md"
```

**Content Research (marketing):**

```bash
# Extract competitor blog for content gap analysis
crawl-cli https://competitor.com/blog --discover -m 50 -O "./content-research/competitor-blog/"
```

### Output Integration

crawl-cli outputs feed directly into analysis workflows:

- **Markdown files** → Read and analyze for positioning, messaging, features
- **JSON output** → Process programmatically for structured analysis
- **Directory output** → Browse individual pages for detailed review
