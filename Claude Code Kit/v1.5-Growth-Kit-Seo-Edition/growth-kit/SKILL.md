...
SEO LAYER (complete SEO system - see seo/skill-overview.md)
├── seo/workflow-0-audit (audit current state)
├── seo/workflow-1-discovery (keyword research via MCP)
├── seo/workflow-2-organization (cluster and prioritize)
├── seo/workflow-3-generation (create optimized content)
├── seo/workflow-4-enhancement (improve existing rankings)
...
### Workflow 1: "I Have a New Product Idea"
...
### Workflow 2: "I Need to Understand My Market"
...
**For keyword research:** Continue to `seo/workflow-1-discovery.md` and `seo/workflow-2-organization.md`.

---

### Workflow 3: "I'm Starting Marketing From Zero"
...
3. seo/workflow-1-discovery.md + seo/workflow-2-organization.md
...
2. seo/workflow-0-audit.md (if existing site)
   └── Audit current state, identify opportunities

3. seo/workflow-1-discovery.md
   └── Discover keyword opportunities via DataForSEO MCP

4. seo/workflow-2-organization.md
   └── Categorize, cluster, and prioritize keywords

5. seo/workflow-3-generation.md (repeat for priority keywords)
...
**For existing content optimization:** Use `seo/workflow-4-enhancement.md` instead of creating new content.
...
3. Audit current content
   └── Compare to marketing/seo-content quality checklist
...
| Get traffic      | seo/workflow-1-discovery         | seo/workflow-2-organization  | seo/workflow-3     | content-repurposer |
...
| Build authority  | voice-profiler                   | seo/workflow-3 OR newsletter | content-repurposer | -                  |
...
| Improve rankings | seo/workflow-4-enhancement       | -                            | -                  | -                  |
...
| Don't know what to write about     | seo/workflow-1-discovery         |
| Don't have an opt-in offer         | marketing/lead-magnet-builder    |
| Don't have landing pages           | marketing/direct-response-copy   |
| Don't have SEO content             | seo/workflow-3-generation        |
| Content not ranking well           | seo/workflow-4-enhancement       |
...
| SEO reference guide      | `seo/references/seo-master-reference.md`             |
