---
name: growth-kit-media-creation
description: "AI visual direction and image generation. Use when user needs hero images, social graphics, visual concepts, brand imagery, or visual strategy. Integrates with Glif MCP for AI image generation. Outputs visual assets optimized for all platforms."
---

# Media Creation Skill Pack

Your AI visual director and strategic thinking partner. Use for ANY visual challenge: campaigns, naming, concepts, angles, visual direction, messaging, or when you're stuck and need fresh ideas.

---

## What This Is

A modular system for visual asset creation:

- **Strategy** - Brainstorming, concept generation, angle finding
- **Execution** - Image generation, social graphics
- **Reference** - Visual psychology, anti-generic techniques

**Think of it as:** A fractional Visual Director in your Claude Code. Generates visual assets based on strategic direction.

**Related Skills:**

- `idea-to-product` - For product discovery and validation
- `research` - For competitor analysis and positioning
- `marketing` - For copy, content, and distribution
- `crawl-cli` - For competitor visual research
...
| --------------------------------- | --------------------------------- | ------------------------ | ------------------------ |
| **skill-overview.md** (this file) | Visual strategy and orchestration | Challenge, goal, context | Concepts, angles, briefs |
| **image-generation**              | Core AI image generation          | Subject, style, platform | Production-ready images  |
| **social-graphics**               | Platform-optimized graphics       | Platform, content type   | Social media assets      |

### references/

| Reference               | Contains                                                     | Use With        |
| ----------------------- | ------------------------------------------------------------ | --------------- |
| **visual-intelligence** | Visual psychology, anti-generic techniques, style vocabulary | All visual work |

**When to load references:**

- Starting any visual project? Load `visual-intelligence` first
- Need to avoid generic AI output? Load `visual-intelligence`
- Working on brand visuals? Load `visual-intelligence` for style taxonomy
...
**Use crawl-cli skill** to scrape competitor sites for visual analysis.
...
Each analogy suggests different visual directions
```
...
Not every visual challenge needs images. But when it does, the difference between forgettable and distinctive is intentionality.

> **Reference:** See `references/visual-intelligence.md` for deep dive on visual psychology, anti-generic techniques, style vocabulary, and platform strategies.
...
3. IDENTIFY WINNER     - What resonates? Why?
...
| **3D Premium**        | Chrome, metallic, atmospheric lighting                  |
...
Route to: image-generation / social-graphics
```
...
**The Goal:** Never create one-off assets. Always build systems that generate multiple pieces of content from a single visual direction.
...
| Input                | Use In Media Assets      |
| -------------------- | ------------------------ |
| Competitor analysis  | Visual differentiation   |
| Target segments      | Audience-specific angles |
| Positioning strategy | Angle selection          |

### From marketing skill:

| Input            | Use In Media Assets |
| ---------------- | ------------------- |
| Voice profile    | Tone consistency    |
| Hook/positioning | Angle foundation    |
| Content plan     | Asset requirements  |

### To marketing skill:

| Output          | Use In Marketing      |
| --------------- | --------------------- |
| Visual assets   | Content distribution  |
| Brand direction | Consistent execution  |
| Content systems | Repeatable production |

---

## Quick Start: Routing by Goal

### "I Need Landing Page Visuals"

**Sequence:**

```
1. skill-overview.md (this file)
   Define angle and visual direction

2. image-generation
   Create hero images, feature illustrations

3. social-graphics (optional)
...
```
1. skill-overview.md (this file)
   Develop content system concept

2. social-graphics
   Generate platform-optimized assets

3. Build series from system
```

### "I'm Stuck on Messaging"
...
2. Select winning angle

3. Route to marketing skill for copy
```
...
**Visual Exploration:** 3-5 genuinely different style directions
...
Before finalizing any visual direction:
...
When routing to execution skills:

```markdown
## Visual Strategy Handoff

**The Insight:** [What we're exploiting]
**The Angle:** [Our specific approach]
**The Concept:** [Visual idea]
...
**Style Principles:** [Transferable rules]
