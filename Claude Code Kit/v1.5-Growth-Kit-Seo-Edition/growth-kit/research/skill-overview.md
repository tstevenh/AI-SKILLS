...
| **keyword-research**     | Finds what to write about  | Business context, audience       | Prioritized keyword clusters     |

**Supporting Tool:** Use the `crawl-cli` skill for web crawling and content extraction.
