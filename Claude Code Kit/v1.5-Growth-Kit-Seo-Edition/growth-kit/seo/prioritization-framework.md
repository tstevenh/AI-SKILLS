...
└─ YES → Is existing content ranking?
          ...
          └─ YES → What position?
                    ...
                    ├─ 4-10 → OPTIMIZE (Workflow 4 - quick wins)
                    ├─ 11-20 → OPTIMIZE (Workflow 4 - priority)
...
│   └─ → Workflow 1 (research) → Workflow 2 (organize) → Workflow 3 (create)
│
├─ Blue ocean opportunity (no one covers well)
│   └─ → Validate demand → Workflow 1-3
│
├─ Technical issue
...
└─ Content consolidation
    └─ → Merge content → Workflow 4 on merged page
```
...
Run Workflow 0 or quick audit to update:
...
- Week 3-4: [New content from Workflow 3]
...
| After Workflow 0 audit | Score and tier all opportunities |
...
*End of SEO Prioritization Framework*
