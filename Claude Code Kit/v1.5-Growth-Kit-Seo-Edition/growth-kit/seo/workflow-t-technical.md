...
- **Validate syntax:** https://validator.schema.org/
...
| URL slug | 75-100 chars | Shorter = better for sharing |
...
<head>
  ...
  <meta name="description" content="{{compelling_description_with_keyword_and_cta}}">
...
**Bad:**
```html
<img alt="dog">  <!-- Too vague -->
<img alt="Image of cute puppy photo">  <!-- Redundant -->
<img alt="">  <!-- Missing for meaningful image -->
```
...
Workflow 0 identifies technical issues → Use this guide to implement fixes.

### From Workflow 4 (Rank Enhancement)

Workflow 4 recommends on-page improvements → Use Section 3 (Meta Tags) and Section 2 (Schema).
...
*For use with agentic coding AI agents*
