...
Generate **3-5 compelling lead magnet concepts** for any business, each with:
...
Apply the value equation to lead magnet concepts:
...
Before crafting the lead magnet, verify you're targeting the right market.

**Market > Offer > Persuasion**

A mediocre lead magnet to a starving crowd beats a great lead magnet to an indifferent market.

### The three criteria:

1. **Massive Pain** - Not a mild inconvenience. Genuine suffering, financial loss, urgent problem.

2. **Purchasing Power** - They have money and willingness to spend on solutions.
...
### Step 1: List All Problems Exhaustively

List every obstacle between the prospect's current state and the dream outcome:
...
The more problems you identify, the more targeted your lead magnet can be.

### Step 2: Transform Problems into Solutions

For each problem, create a solution:

- "I don't know how" → "Step-by-step system that shows exactly what to do"
- "I don't have time" → "2-hour-per-week system" or quick implementation template
- "I've tried before and failed" → "Personalized approach based on why previous attempts failed"

Your lead magnet should solve ONE of these problems completely.
...
- **Done-for-you** (highest perceived value)
- **Done-with-you** (mid value)
- **Do-it-yourself** (lowest barrier to entry)
...
For lead magnets, typically choose the lowest-barrier format that still delivers genuine value.

### Trim and Stack Principle

Evaluate each element on:

- Value to prospect (high or low)
- Cost to create/deliver (high or low)

**High value, low cost** = Maximum leverage. Include these in lead magnets.
**High value, high cost** = Save for paid offers.
**Low value, any cost** = Cut these entirely.
...
- Implementation: Medium difficulty; needs quiz tool
...
- **voice-profiler** - Ensures lead magnet voice matches brand
- **hook-finder** - Provides the angle for the hook
- **target-segments** - Informs what audience wants

**lead-magnet feeds:**

- **direct-response-copy** - Creates landing page for lead magnet
- **email-sequences** - Builds welcome sequence to deliver and convert

**The flow:**

1. lead-magnet generates concepts
2. Choose best concept
3. direct-response-copy writes the opt-in page
4. email-sequences builds the delivery and nurture flow
...
1. **Is it specific?** Vague lead magnets fail. Specific ones convert.

2. **Does it solve one problem completely?** Not a teaser but a genuine quick win.

3. **Is the bridge obvious?** Can you see how consuming this leads to wanting the paid offer?

4. **Would the target audience actually want this?** Not "should want" but ACTUALLY want, right now.
...
- Build the landing page (that's direct-response-copy skill)
- Write the email sequence (that's email-sequences skill)
