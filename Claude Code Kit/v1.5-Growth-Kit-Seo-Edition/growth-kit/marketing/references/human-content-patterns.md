# Human Content Patterns

Best-in-class examples of human-written content that demonstrates Experience, Expertise, Authoritativeness, and Trust (E-E-A-T). Study these patterns to differentiate from AI-generated content.
...
## Example 1: The Startup Essay Writer

**Category:** Business/Startups

**Why it works:**

This writer produces essays that rank and get shared because they have an unmistakable point of view backed by decades of startup experience.

**E-E-A-T signals:**

- **Experience:** Founded a major accelerator, funded thousands of startups, specific stories from specific companies
...
- **Trust:** Admits when uncertain, acknowledges counterarguments, updates views
...
## Example 2: The Science Explainer

**Category:** Long-form Explainers

**Why it works:**

This writer takes complex topics and explains them in ways that feel like a brilliant friend explaining over drinks. Deep research made accessible through personality.
...
## Example 3: The Tech Strategy Analyst

**Category:** Tech/Business Analysis

**Why it works:**

This writer has produced daily analysis of tech strategy for 10+ years. Deep expertise applied to current events with a consistent analytical framework.

**E-E-A-T signals:**

- **Experience:** Worked at major tech companies; analyzes from practitioner POV
- **Expertise:** Developed original frameworks, applies them consistently
...
## Example 4: The Habits Author

**Category:** Self-improvement/Science

**Why it works:**

This writer covers habits with research backing AND personal application. Every principle is grounded in science, then made practical through real examples.
...
- **Authority:** Book sold millions of copies, cited by academics and practitioners
...
## Example 5: The SEO Practitioner

**Category:** Marketing/SEO

**Why it works:**

This writer creates SEO content that demonstrates exactly what good SEO content looks like. Every tactic is backed by data from actual experiments.

**E-E-A-T signals:**

- **Experience:** "I tested this on 50 sites" - actual implementation
- **Expertise:** Original research, coined techniques that became industry standards
...
> "I recently used a content improvement technique to increase my search engine traffic by 110% in 14 days.
>
> And in today's post I'm going to show you exactly how I did it, step-by-step.
>
> But first, a little background:
>
> Back in 2013, I had just started my blog. Like most new sites, I was struggling to get traffic and backlinks. I tried guest posting. I tried broken link building. Nothing worked.
>
...
## Example 6: The Product Management Newsletter

**Category:** Product/Tech

**Why it works:**

This writer covers product management by interviewing practitioners and synthesizing their actual experiences. Primary research, not aggregation.

**E-E-A-T signals:**

- **Experience:** Former PM at a major tech company, builds advice from real product work
- **Expertise:** Interviews 100+ top PMs, synthesizes patterns
- **Authority:** Most-read newsletter in the space, cited across industry
- **Trust:** Names sources, shows methodology, updates based on feedback

**Sample passage:**

> "I surveyed 50 product leaders at top companies. I asked them one question: 'How do you actually decide what to work on next?'
>
> The answers surprised me. Only 3 of 50 use a formal prioritization framework like RICE or ICE. The rest?
>
> 'We just know,' said one head of product. 'After years of doing this, you develop intuition for what matters.'
>
...
- Primary research methodology stated explicitly (50 leaders)
- Honest results even when they contradict expectations
- Real quotes from real practitioners
- Going deeper when initial answer is unsatisfying

---

## Example 7: The Entrepreneur Essayist

**Category:** Business/Philosophy

**Why it works:**

This writer produces short, punchy essays that take unconventional positions and defend them with personal experience. Every post has a clear POV.

**E-E-A-T signals:**

- **Experience:** Founded and sold a company, musician, programmer
...
## Example 8: The Finance Writer

**Category:** Finance/Economics

**Why it works:**

This writer explains complex financial concepts with humor and clarity. Makes derivatives and securities law genuinely entertaining. Writes daily, maintains consistent voice.

**E-E-A-T signals:**

- **Experience:** Former investment banker, practiced M&A law
...
## Example 9: The Food Science Writer

**Category:** Food/Consumer

**Why it works:**

This writer applies scientific methodology to cooking. Tests dozens of variations, measures results, explains the chemistry. Recipes backed by experimentation, not tradition.

**E-E-A-T signals:**

- **Experience:** Professional chef, science background, thousands of recipe tests
- **Expertise:** Food science depth that goes beyond any cookbook
- **Authority:** Award winner, definitive voice on technique
...
## Example 10: The Systems Programming Educator

**Category:** Tech/Engineering

**Why it works:**

This writer explains complex systems programming topics in ways that feel approachable without dumbing down. Uses drawings, genuine curiosity, and "here's what confused me" framing.

**E-E-A-T signals:**

- **Experience:** Software engineer at a major company, builds tools based on learning
...
## Example 11: The Longevity Physician

**Category:** Healthcare/Medical

**Why it works:**

This writer covers longevity and medicine with practitioner depth. Actually reads the papers, explains the statistics, applies findings to their own practice.

**E-E-A-T signals:**

- **Experience:** Practicing physician, personal health transformation, works with patients
- **Expertise:** Top medical school trained, reads primary literature deeply
...
## Example 12: The Behavioral Finance Author

**Category:** Finance/Psychology

**Why it works:**

This writer covers money and decision-making through the lens of psychology and history. Stories and principles, not just numbers.

**E-E-A-T signals:**

- **Experience:** Investment partner, years covering finance
- **Expertise:** Historical depth, behavioral science synthesis
- **Authority:** Book sold millions of copies, read by investors and general audience
- **Trust:** Simple language, admits what can't be predicted

**Sample passage:**

> "A janitor and gas station attendant died with $8 million. A Harvard MBA executive went bankrupt. The janitor saved what little he could and invested it in blue chip stocks. He then waited. For decades. That's it. The executive borrowed heavily to fund a lifestyle. When the market turned, he had no cushion. The highest form of wealth is the ability to wake up every morning and say, 'I can do whatever I want today.'"
...
## Example 13: The Engineering Analyst

**Category:** Tech/Performance

**Why it works:**

This writer produces deep technical analyses backed by measurement and data. Will actually benchmark things instead of repeating assumptions. Contrarian takes backed by evidence.

**E-E-A-T signals:**

- **Experience:** Worked at major tech companies on performance-critical systems
...
> "People say modern computers are fast. I measured input lag on every device I could find. A 1983 computer responds to keystrokes in 30ms. A 2022 laptop? 80-120ms. We've gone backwards. Not by a little - by 3-4x. I tested 50+ devices. The pattern is consistent. We traded latency for features nobody asked for."
...
## Example 14: The First Amendment Attorney

**Category:** Legal

**Why it works:**

This writer explains constitutional law and legal concepts with humor and accessibility while maintaining accuracy. Makes law interesting to non-lawyers.
...
## Example 15: The Cybersecurity Journalist

**Category:** Cybersecurity

**Why it works:**

This writer broke some of the biggest cybersecurity stories of the last decade through investigative reporting and source cultivation. Technical depth for practitioners, accessible enough for executives.

**E-E-A-T signals:**

- **Experience:** Former major newspaper reporter, now independent investigator
- **Expertise:** Breaks original stories through deep source networks
- **Authority:** Stories cited by FBI, Congress, major media
- **Trust:** Protects sources, shows evidence, admits what unknown

**Sample passage:**

> "On March 14, a source contacted me with a spreadsheet listing 533 million users whose personal data had been scraped. I've spent the past two weeks verifying this data. The breach is real. Here's what I found, who's affected, and why the company's response doesn't hold up."
...
## Example 16: The Recruiting Practitioner

**Category:** HR/Recruiting

**Why it works:**

This writer covers recruiting with practitioner credibility - actually does the work, then teaches from experience. Challenges conventional HR wisdom with evidence.

**E-E-A-T signals:**

- **Experience:** Started in recruiting, built teams at major companies
...
## Example 17: The Revenue Operations Executive

**Category:** RevOps/Sales

**Why it works:**

This writer built RevOps practices at multiple Fortune 500 companies, then started teaching what actually works vs. what vendors sell.
...
## Example 18: Enterprise Engineering Blogs

**Category:** Enterprise B2B/Tech

**Why it works:**

Enterprise engineering blogs show how large companies can produce content with genuine technical depth. Real engineers writing about real problems they solved.
...
- **Authority:** Powers millions of customers, handles massive scale
...
## Example 19: VC/Startup Operator Interviews

**Category:** Startup/VC

**Why it works:**

In-depth interviews with startup operators sharing specific tactics. Primary source material, not secondhand advice.
...
- **Authority:** Stories from teams at top startups
- **Trust:** Named sources with specific contexts, not anonymous tips

**Sample passage (interview with an early startup marketer):**

> "When I joined, we had no marketing team, no brand guidelines, and developers as our only audience. Here's what we did in the first 90 days - and more importantly, what we deliberately didn't do. Most startups try to boil the ocean. We ignored everything except one channel until we owned it."
...
## Example 20: The Physician-Author

**Category:** Medical/Science

**Why it works:**

This writer covers medicine and science with literary quality while maintaining scientific accuracy. Makes complex biology genuinely compelling.

**E-E-A-T signals:**

- **Experience:** Practicing physician, sees patients weekly
- **Expertise:** Top faculty position, researcher, award winner
- **Authority:** Advises on policy, cited by researchers and clinicians
- **Trust:** Shows complexity, admits unknowns, humanizes patients

**Sample passage:**

> "In 1947, a Boston pathologist sent away for a few grams of a chemical compound. He wanted to test a theory: that blocking folic acid might stop cancer cells from dividing. He had no clinical trial, no ethics board approval, no pharmaceutical company behind him. He had dying children and an idea. What happened next changed everything."

**What to steal:**

- Narrative tension in scientific writing
- Specific details (year, location, compound)
...
Not "many" or "significant" but "248 people" or "14 days" or "$8 million."

### 3. Named Sources

Real people, real companies, real quotes. Not "experts say" but specific attribution.
...
- Does it have a specific author voice?
- Does it go deep on research?
- Does it have analytical frameworks?
- Does it cite specific studies with numbers?
- Does it show methodology?
- Does it use primary sources?
- Does it take clear positions?
...
| Vertical               | Key Patterns                                   |
| ---------------------- | ---------------------------------------------- |
| **Marketing/Business** | Conviction, methodology, primary research      |
| **Finance**            | Complex made accessible, stories over jargon   |
| **Tech/Engineering**   | Measurement, curiosity, admitting failures     |
| **Healthcare/Medical** | Primary sources, nuance, human stakes          |
| **Cybersecurity**      | Investigative rigor, verification transparency |
| **Legal**              | Precision, accessible expertise, humor         |
| **HR/Recruiting**      | Practitioner credibility, industry BS-calling  |
| **RevOps/Sales**       | Implementation experience, vendor skepticism   |
| **Food/Consumer**      | Scientific method, myth-busting with data      |
| **Startups/VC**        | Primary interviews, named sources, tactics     |
| **Deep Explainers**    | Research depth, original frameworks            |
