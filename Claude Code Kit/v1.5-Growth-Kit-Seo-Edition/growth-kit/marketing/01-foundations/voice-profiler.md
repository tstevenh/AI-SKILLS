...
- **Radical transparency:** Shares real numbers, real failures, real timelines. Nothing hidden.
...
**Jargon level:** Light - uses industry terms but explains concepts simply
...
- "I believed I was the next big thing, built a startup for 1 year, and got 0 users."
...
New coaching business. Personality: direct, warm, no-BS. Audience: overwhelmed entrepreneurs. Positioning: experienced peer, not guru. Admires: clarity and simplicity in communication. Hates: hustle culture, fake positivity.
...
1. Run voice-profiler first (Extract or Build)
