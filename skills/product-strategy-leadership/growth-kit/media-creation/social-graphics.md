...
Platform-optimized graphics for social media. Not generic images that happen to be the right size - graphics engineered for each platform's specific algorithm, user behavior, and visual language.
...
**Primary: Nano Banana Pro via Glif**

| Model                            | Glif ID                     | Speed  |
| -------------------------------- | --------------------------- | ------ |
| **Nano Banana Pro Text 2 Image** | `cmi7ne4p40000kz04yup2nxgh` | ~20sec |

**Exception:** For text-heavy graphics (quote cards, announcement graphics), use Recraft v3 or Ideogram v3 for superior text rendering.
...
**Route to text-focused model for best results** (text rendering critical)
...
4. **Visual language matching** - LinkedIn is not TikTok aesthetically
